...
The analyses compare two methods for measuring delay discounting—the Adjusting-Amount (Adj-Amt) procedure and the Monetary Choice Questionnaire (MCQ) using a variety of statistical techniques, including nonlinear regression, beta regression, correlation, and ANOVA.
